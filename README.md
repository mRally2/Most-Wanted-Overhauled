...
Handbrake has also quite a big part in making this model shine. It has been tuned to be enabled shortly to trigger the drift component Criterion programmed for smooth transitions and manouvrability through tight corners and also has been set to decrease the speed of the vehicle during the powerslide instead of the other way around used for the vanilla drift model. This way gripping and drifting through a corner will not have much difference in speed. You also have the choice of using it for a short period of time when cornering while full steering, kind of like a regular brake if you ever need it.

Having this new model in place, you must think twice where to use your NOS, whether you want to step on slippery surfaces with less than 4 wheels or not, gripping a low speed corner or drift it through and much more. There’s also this phenomenon where if you have your steering full locked on one side or the brake pressed when landing a big jump, you will spin out guaranteed. The physics are this complex if you ever thought about it. You can give it a try in multiplayer as well while the servers are still up.
